...
const Generalheader = () => {
  ...
  return (
    <header className="fixed top-0 z-40 w-full border-b border-white/10 bg-AppBlack shadow-md">
      <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between gap-3 px-4 lg:h-[68px] lg:px-6">
        ...
        <div className="flex min-w-0 flex-1 items-center justify-center gap-3 lg:justify-start">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-white/20 bg-white lg:h-11 lg:w-11">
            <Logo />
          </div>
          ...
          <span className="hidden shrink-0 rounded-full bg-AppGreen px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white lg:inline-block">
            Teacher Portal
          </span>
        </div>
